...
std::string materialImplication::getString() const {
...
bool materialImplication::calculate(const truthTable* p_truthTable, const int row) const {
    bool value1, value2;
...
int materialImplication::getTruthFunctionCount() const {
